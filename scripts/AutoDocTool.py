...
def get_basic_html():
    ...
    basic =  """
        ...
        Text in <b>bold</b> results from evaluating a code expression.
        </p>

        <p>This data was generated by user <b>{}</b> on <b>{}</b>.
        If you are reading this online, please note that you can run this <b>{}</b> script
...
def get_code_push():
    ...
    codepush = """
        ...
        <p>
        You can push code to the WebWidgets.io server using the <b>{}</b> script.
...
def get_data_push_pull():
    ...
    pushpull += """
        <p>
        If you attempt to run <b>{}</b> but you already have a DB file in the target location,
...
def get_config():
    ...
    topstr = """
        ...
        For example, for the username <b>{}</b>
        </p>

        <ul>
        <li>Name of subfolder: <b>{}</b></li>
        <li>User home: <b>{}</b></li>
        <li><b>{}</b></li>
        </ul>
