...
{ 
	...
	public static File MAINTENANCE_MODE_FILE = new File(LifeUtil.MISC_DATA_DIR + "/MAINTENANCE_MODE_MARKER.txt");	
	...
	public static String includeCheckRelativePath(String relpath) 
	{
		...
		String prefix = Util.sprintf("%s/%s", LifeUtil.WIDGETS_DIR, WidgetUser.getSharedUser());
		...
		long cksum = LifeUtil.getFileCkSum(mainfile);
